...
| | `--cremind-documents` | This profile's own Cremind documentation + its embeddings | ❌ | ✅ |
| | `--documentation-search` | Documentation search index, captions and settings (your files are not touched) | ❌ | ✅ |
...
| `--skills` | Reset persona + skills to shipped defaults. |
| `--cremind-documents` | This profile's own Cremind documentation + its embeddings. |
| `--documentation-search` | Documentation search index, captions and settings. The indexed folder and your files are never touched. |
| `--browser-login` | Saved browser login state. |
