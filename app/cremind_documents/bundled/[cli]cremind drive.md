...
Indexing such a Drive for search (`cremind docs drive enable`) needs folders
...
Drive files indexed for search (`cremind docs drive`) — at once through
