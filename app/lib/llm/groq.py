...
class GroqLLMProvider(LLMProvider):
    # Memo key for the max_tokens/max_completion_tokens adaptation. Constant:
    # Groq serves a single endpoint. Class-level so partially-constructed
    # instances still resolve it.
    _max_tokens_endpoint: str = "groq"
        ...
        while True:
            ...
            try:
                ...
                if is_unsupported_max_tokens(err) and not renamed_max_tokens:
                    ...
                    logger.info(
                        f"[llm:groq] {self.model_name} rejected max_tokens; "
