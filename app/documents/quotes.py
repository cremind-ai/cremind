...
- **normalized** — equal after :func:`~app.documents.textnorm.normalize_for_match`
...
from app.documents.textnorm import normalize_for_match
...
def _strip_marks(s: str) -> str:
    ...
    :func:`~app.documents.textnorm.fold`, so a segment comparison can't mistake
