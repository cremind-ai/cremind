"""The Documentation search query engine: what the agent tool and the query
...
from app.documents.query.engine import Access, QueryEngine, SearchOutcome, open_engine
from app.documents.query.filters import FilterError, Filters, parse_filters
from app.documents.query.reader import ReadError
