...
from app.userdocs.query.fusion import W_LEXICAL, W_LEXICAL_IDS, W_PHRASE, W_VECTOR, RankedList, rrf
from app.userdocs.query.lexical import search_lexical
from app.userdocs.query.terms import analyze
from app.userdocs.query.vector import search_vector
...
def _no_vec(engine: Any) -> Any:
    from app.userdocs.query.vector import VectorResult
...
def find(
    ...
    *,
    ...
    from app.userdocs.query.engine import RELAX_STEPS, status_notes
