...
:mod:`app.userdocs.chunking.chunker`), so that renaming or moving a 200-chunk
...
from app.userdocs.chunking.chunker import MAX_TOKENS, _chunk
from app.userdocs.types import CTYPE_CAPTION, CTYPE_FILE_CARD, CTYPE_FOLDER_CARD, CTYPE_OCR, Block, Chunk
