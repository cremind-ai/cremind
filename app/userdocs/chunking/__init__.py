"""Chunking for User Document Search: blocks in, embeddable chunks out.
...
Pure functions over :mod:`app.userdocs.types`; no I/O, no DB, no model.
"""

from app.userdocs.chunking.cards import (
    make_caption_chunk,
    make_file_card,
    make_folder_card,
    make_ocr_chunks,
)
from app.userdocs.chunking.chunker import CHUNKER_VERSION, chunk_blocks
from app.userdocs.chunking.diff import diff_chunks
from app.userdocs.chunking.legal import (
    detect_legal_meta,
    extract_refs,
    looks_legal,
    section_key_for,
