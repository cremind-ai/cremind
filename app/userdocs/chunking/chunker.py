...
:func:`~app.userdocs.textnorm.estimate_tokens` estimates, MIN=120,
TARGET=300, MAX=420, WINDOW=0.6·TARGET=180):

1. Legal documents (≥5 article headings, or ``legal=True``) first go through
   :func:`~app.userdocs.chunking.legal.apply_legal_structure`.
...
from app.userdocs import textnorm
from app.userdocs.chunking import legal as _legal
from app.userdocs.types import ANCHOR_HARD, ANCHOR_SOFT, CTYPE_BODY, Block, Chunk
