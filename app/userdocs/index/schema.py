"""Schema of the per-profile User Document Search index file.

The index file (``<SYSTEM_DIR>/storage/userdocs/<profile_uid>/index.db``) is
...
rebuilds (see :class:`app.userdocs.index.db.IndexIncompatible`).
