...
class ResearchActivity:
    ...
    async def _patch_persisted(self) -> None:
        try:
            ...
            logger.exception(f"[userdocs] research activity: could not patch the saved message of "
    ...
    async def _publish_now(self) -> None:
        ...
        try:
            ...
            logger.exception(f"[userdocs] research activity: could not publish for {self.conversation_id}")
