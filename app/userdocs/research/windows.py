...
where it can be, each chunk printed after its citation token:
    ...
    [ud:k7m2xq9a#1f3c9a0b] Điều 203, khoản 2
    <the chunk's text>
...
from app.userdocs.cite import escape_in_document_text, locator_label, make_token
from app.userdocs.research.context import estimate_tokens
