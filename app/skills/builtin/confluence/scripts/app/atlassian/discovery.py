...
client id + per-resource scopes to use and the relay WebSocket URL. Unlike the
Google skills, NO client secret is fetched here — Atlassian's secret is
confidential and stays on the backend, which mediates the token exchange.
"""
