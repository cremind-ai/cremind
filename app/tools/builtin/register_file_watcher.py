        ...
        "properties": {
            ...
            "action": {
                ...
                "description": (
                    ...
                    "(path/type/timestamp) into it, and leave OUT the trigger "
                    "itself (which folder/path is watched and which file event "
                    "fires it — those are captured structurally in the watcher's "
                    "own fields); the runtime appends a "
