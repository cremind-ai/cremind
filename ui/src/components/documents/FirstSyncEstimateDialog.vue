...
import type { DocumentsEstimate, DocumentsStorageSnapshot } from '../../services/documentsApi';
import { formatBytes, formatCount, formatDuration } from '../../utils/documentsView';

const props = withDefaults(defineProps<{
  modelValue: boolean;
  estimate: DocumentsEstimate | null;
  storage?: DocumentsStorageSnapshot | null;
