 ...
 * `GET /api/documentation-search/drive/folders` — the same `DriveClient` the sync uses, so
...
async function addPasted() {
  ...
  try {
    ...
    pasteError.value = e instanceof DocumentsApiError && e.code !== 'DriveUnreachable' && e.code !== 'DriveNotLinked'
