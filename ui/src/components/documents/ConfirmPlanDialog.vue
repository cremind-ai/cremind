 ...
 * Documentation search change (moving the folder, exclude rules that drop
...
import type { ChangePlan } from '../../services/documentsApi';
import { effectLabel } from '../../utils/documentsView';
...
<template>
  ...
  >
    ...
    <template #footer>
      ...
      <ElButton
        :class="{ 'doc-danger': plan?.destructive }"
