...
import type { DocumentsStorageInfo, DocumentsStorageSnapshot } from '../../services/documentsApi';
import { formatBytes } from '../../utils/documentsView';

const props = withDefaults(defineProps<{
  storage: DocumentsStorageSnapshot | null | undefined;
  detail?: DocumentsStorageInfo | null;
}>(), { detail: null });
