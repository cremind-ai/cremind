...
import type { UserDocsOptions, UserDocsVisionView } from '../../services/userdocsApi';
import { formatCount, visionQuota, visionStatus } from '../../utils/userdocsView';

type CaptionOptions = UserDocsOptions['caption'];

const props = withDefaults(defineProps<{
  caption: CaptionOptions;
  vision: UserDocsVisionView | null | undefined;
