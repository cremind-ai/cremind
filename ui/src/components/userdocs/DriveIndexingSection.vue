...
import UserDocsStatePanel from './UserDocsStatePanel.vue';
...
const props = withDefaults(defineProps<{
  ...
  source: UserDocsSource | null;
  link: UserDocsDriveLink | null;
...
<template>
  <div class="drive">
    ...
    <UserDocsStatePanel v-if="banner" :banner="banner" :busy="busy || saving" @action="onBannerAction" />
    ...
    >
      ...
      <template #footer>
        ...
        <ElButton class="ud-danger" :loading="busy" @click="emit('confirm-deletions')">Remove them</ElButton>
      </template>
    </ElDialog>
  </div>
</template>
