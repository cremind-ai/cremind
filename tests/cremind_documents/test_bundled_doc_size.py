...
its budget is still usable — cremind_documentation_search then delivers its head, a
...
from app.cremind_documents.sections import open_fence_at_end

pytest.importorskip("tiktoken", reason="the delivery budget is measured in tiktoken tokens")

import app.tools.builtin.cremind_documentation_search as ds  # noqa: E402
...
def _budget(stem: str) -> int:
    """The body budget cremind_documentation_search gives this doc at the default clamp."""
    reserved = (
