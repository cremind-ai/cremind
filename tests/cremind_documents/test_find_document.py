...
``CremindDocumentSyncService.find_document`` turns an AGENT-SUPPLIED document name into
...
from app.cremind_documents.sync import SHARED_SCOPE, CremindDocumentSyncService
