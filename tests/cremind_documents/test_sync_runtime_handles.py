"""CremindDocumentSyncService takes its embedding handles from the live state.
...
Cremind documentation search kept querying a store the admin had just disabled — and an
