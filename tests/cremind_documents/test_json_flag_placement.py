...
def test_the_walk_finds_the_payload_json_commands():
    ...
    make sure the CLI directive in cremind_documentation_search.py lists it."""
...
def test_the_directive_names_every_payload_json_command():
    from app.tools.builtin.cremind_documentation_search import _CLI_EXECUTION_DIRECTIVE
