...
defaults to INFO — so ``logs/app.log`` never said whether Cremind documentation search
...
from app.cremind_documents.sync import COLLECTION_NAME, CremindDocumentSyncService
