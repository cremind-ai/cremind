...
from app.userdocs.chunking.chunker import HEADING_MAX_TOKENS, MAX_TOKENS, MIN_TOKENS
...
from tests.userdocs.legal_samples import english_act_blocks, vietnamese_law_blocks
