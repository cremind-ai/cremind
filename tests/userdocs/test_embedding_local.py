...
search, memory) and User Document Search's background indexer. These tests
...
from app.userdocs import embed_prompts
...
def test_userdocs_methods_add_the_trained_prompts():
    p = FakeProvider()
    e = LocalEmbeddings(provider=p)
...
def test_sentence_transformer_providers_batch_with_prefixes(module_name, cls_name, key):
    ...
    # The class prompts and the userdocs table must agree.
