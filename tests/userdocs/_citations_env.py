"""A small, real User Document Search world for the citation tests.
...
out that real :class:`~app.userdocs.index.IndexDB`, which is all the citation
code asks of it.
"""
...
import app.storage.userdocs_citations_storage as cit_module
import app.storage.userdocs_storage as uds_module
from app.config.settings import BaseConfig
from app.databases.sqlite import SqliteDatabaseProvider
from app.storage.userdocs_citations_storage import UserDocCitationsStorage
from app.storage.userdocs_storage import UserDocsStorage
from app.userdocs import service as svc_module
from app.userdocs.cite import IssuedCitation, locator_label, make_token
from app.userdocs.index import IndexDB, index_path
from app.userdocs.textnorm import text_hash
...
def build(tmp_path: Path, monkeypatch) -> SimpleNamespace:
    ...
    cit = UserDocCitationsStorage(provider)
