...
from app.documents.chunking.chunker import MAX_TOKENS
from app.documents.chunking.legal import apply_legal_structure
from app.documents.types import ANCHOR_HARD, ANCHOR_NONE, ANCHOR_SOFT, Block
from tests.documents.legal_samples import (
    english_act_blocks,
