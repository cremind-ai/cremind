...
The shared embedder now serialises model calls behind a lock, and a Documentation
search batch may hold it for a few hundred milliseconds. The two chat
tools that embed a query synchronously — ``cremind_documentation_search`` (via the doc
